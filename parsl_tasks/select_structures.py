...
def select_structures(config):
    ...
    # return "OMP_NUM_THREADS=128 python {} --ef_threshold {} --num_workers {} --csv_file {} --nomix_dir {}".format(dir_select_structure, str(config["ef_thr"]), config["num_workers"], tr_csv_file, dir_structures)
